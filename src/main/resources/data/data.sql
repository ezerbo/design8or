...
insert into user(id, first_name, last_name, email_address) values (5, 'Sanji'  , 'Vinsmoke' , 'sanji.vinsmoke@onpiece.com'   );
insert into user(id, first_name, last_name, email_address) values (6, 'Nami'   , 'Cat Burglar', 'nami.navigator@onpiece.com' );
insert into user(id, first_name, last_name, email_address) values (7, 'Usopp'  , 'God'      , 'usopp.sniper@onpiece.com'     );
insert into user(id, first_name, last_name, email_address) values (8, 'Franky' , 'Cutty Flam', 'franky.shipwright@onpiece.com');
insert into user(id, first_name, last_name, email_address) values (9, 'Brook'  , 'Soul King', 'brook.musician@onpiece.com'   );
insert into user(id, first_name, last_name, email_address) values (10, 'Jinbe' , 'Knight'   , 'jinbe.fishman@onpiece.com'    );
insert into user(id, first_name, last_name, email_address) values (11, 'Ace'   , 'Portgas D.', 'ace.fire@onpiece.com'        );
insert into user(id, first_name, last_name, email_address) values (12, 'Sabo'  , 'Revolutionary', 'sabo.flame@onpiece.com'   );
insert into user(id, first_name, last_name, email_address) values (13, 'Law'   , 'Trafalgar', 'law.surgeon@onpiece.com'      );
insert into user(id, first_name, last_name, email_address) values (14, 'Kid'   , 'Eustass'  , 'kid.captain@onpiece.com'      );
insert into user(id, first_name, last_name, email_address) values (15, 'Shanks', 'Red Hair' , 'shanks.emperor@onpiece.com'   );
insert into user(id, first_name, last_name, email_address) values (16, 'Mihawk', 'Dracule'  , 'mihawk.swordsman@onpiece.com' );
insert into user(id, first_name, last_name, email_address) values (17, 'Hancock', 'Boa'     , 'hancock.empress@onpiece.com'  );
insert into user(id, first_name, last_name, email_address) values (18, 'Crocodile', 'Sir'   , 'crocodile.warlord@onpiece.com');
insert into user(id, first_name, last_name, email_address) values (19, 'Doflamingo', 'Donquixote', 'doflamingo.joker@onpiece.com');
insert into user(id, first_name, last_name, email_address) values (20, 'Katakuri', 'Charlotte', 'katakuri.mochi@onpiece.com' );
insert into user(id, first_name, last_name, email_address) values (21, 'Yamato', 'Kozuki'   , 'yamato.oden@onpiece.com'      );
insert into user(id, first_name, last_name, email_address) values (22, 'Marco' , 'Phoenix'  , 'marco.firstmate@onpiece.com'  );
insert into user(id, first_name, last_name, email_address) values (23, 'Whitebeard', 'Edward', 'whitebeard.emperor@onpiece.com');
insert into user(id, first_name, last_name, email_address) values (24, 'Rayleigh', 'Silvers', 'rayleigh.dark@onpiece.com'   );
insert into user(id, first_name, last_name, email_address) values (25, 'Garp'  , 'Monkey D.', 'garp.hero@onpiece.com'        );
insert into user(id, first_name, last_name, email_address) values (26, 'Smoker', 'White Hunter', 'smoker.marine@onpiece.com' );
insert into user(id, first_name, last_name, email_address) values (27, 'Kizaru', 'Borsalino', 'kizaru.admiral@onpiece.com'   );
insert into user(id, first_name, last_name, email_address) values (28, 'Aokiji', 'Kuzan'    , 'aokiji.ice@onpiece.com'       );
insert into user(id, first_name, last_name, email_address) values (29, 'Akainu', 'Sakazuki' , 'akainu.magma@onpiece.com'     );
insert into user(id, first_name, last_name, email_address) values (30, 'Fujitora', 'Issho'  , 'fujitora.gravity@onpiece.com' );
