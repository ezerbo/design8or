...
insert into design8or_db.pool(id, start_date, end_date) values (1, current_timestamp() - 20, current_timestamp() - 10);
insert into design8or_db.pool(id, start_date, end_date) values (2, current_timestamp() - 10, current_timestamp() - 1);
insert into design8or_db.pool(id, start_date, end_date) values (3, current_timestamp() - 1 , null); --Current Pool

insert into design8or_db.assignment(user_id, pool_id, assignment_date) values (2, 3, current_timestamp());

insert into design8or_db.designation(id, user_id, status, designation_date, user_response_date, token) values (1, 1, 'PENDING', current_timestamp(), null, 'Vqiy3c3Z4uGm7rk8SECupeNKoOHeZ7');

insert into design8or_db.app_parameter(id, rotation_time, st_req_timer_delay) values (1, DATEADD('MINUTE', 2, CURRENT_TIME()), 1);
